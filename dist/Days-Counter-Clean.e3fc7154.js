...
var _mainDaysCounterView = require("../views/mainDaysCounterView");
var _mainDaysCounterViewDefault = parcelHelpers.interopDefault(_mainDaysCounterView);
...
const controlLogin = function(inputUsername, inputPassword) {
    ...
    (0, _mainDaysCounterViewDefault.default).renderToParentEle(_model.state.currentAccount);
...
const init = function() {
    ...
    (0, _overlaySetGoalsViewDefault.default).addHandlerClickX(controlClickX);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jxBwr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class MainDaysCounterView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (this._curAccGoalLength) return this._data.goals.map((goal, i)=>{
            const remainingDays = this._data.remainingDays[i];
            remainingDays ? `${remainingDays} days are ${(remainingDays * 24).toFixed(1)} hours` : "", remainingDays ? `${remainingDays} days are ${(remainingDays * 1440).toFixed(1)} minutes` : "You haven't set the date yet!", remainingDays ? `${remainingDays} days are ${(remainingDays * 86400).toFixed(1)} seconds` : "", goal.title ? `Until ${goal.title}` : "You haven't set the title yet!", remainingDays ? `${remainingDays} days are ${(remainingDays / 7).toFixed(1)} weeks` : "", remainingDays ? `${remainingDays} days are ${(remainingDays / (365 / 12)).toFixed(1)} months` : "You haven't set the date yet!", remainingDays ? `${remainingDays} days are ${(remainingDays / 365).toFixed(1)} years` : "";
        }).join("");
    }
}
exports.default = new MainDaysCounterView();

},{"./View":"6XhGS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["aAtWW","bGah5"], "bGah5", "parcelRequire3bdd", {})

//# sourceMappingURL=Days-Counter-Clean.e3fc7154.js.map
